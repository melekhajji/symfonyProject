...
class SecurityController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        else if ($this->getUser()!=NULL && $user->getRoles()[0]=="Candidat"){

            return $this->render('/homefront.html.twig', ['last_username' => $lastUsername, 'error' => $error]);

        }
        else if ($this->getUser()!=NULL && $user->getRoles()[0]=="Recruteur"){

            return $this->render('/entreprisefront.html.twig', ['last_username' => $lastUsername, 'error' => $error]);
