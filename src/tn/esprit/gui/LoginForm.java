     ...
     public LoginForm(Resources theme) {
        ...
        loginButton.addActionListener((evt) -> {
            ...
            if (u!= null) {
                ...
                if(u.getRoles().contains("Candidat")){
                    try {
                        mailUtil.sendMail("marwen.saidi@esprit.tn", "jihene.sliti@esprit.tn", "syrine1997@mat", "mot de passe oublié", "mot de passe oublié", file);
