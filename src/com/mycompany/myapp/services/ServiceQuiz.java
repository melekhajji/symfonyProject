...
public class ServiceQuiz {
    ...
    public boolean addQuiz(Quiz q) {
                String url = Statics.BASE_URL + "/addjsQ/new?theme="+ q.getTheme()+"&duree="+q.getDuree()+ "&nbquestion=" + q.getNbquestion();
            ...
            */
            ...
            for(Map<String,Object> obj : list){
               ...
               q.setId((int)id); 
                ...
                q.setTheme(obj.get("theme").toString());
                
                float duree = Float.parseFloat(obj.get("duree").toString());
                q.setDuree((int)duree);
                
                 float nb = Float.parseFloat(obj.get("nbquestion").toString());
                q.setNbquestion((int)nb);
    ...
    public ArrayList<Quiz> getAllQuizs(){
     String url = Statics.BASE_URL+"/affichermobileQ";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
      ...
      public boolean  Delete(int id){
       String url = Statics.BASE_URL + "/supprimermobileQ/" +id;
