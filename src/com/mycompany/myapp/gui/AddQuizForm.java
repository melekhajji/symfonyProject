    ...
    public AddQuizForm(Form previous) {
        ...
        */
        ...
        TextField tfDuree = new TextField("","Durée");
         TextField tfNbquestion = new TextField("","Nb Questions");
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((tfTheme.getText().length()==0)||(tfDuree.getText().length()==0)||(tfNbquestion.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                else
                {
                    try {
                        Quiz Q = new Quiz(tfTheme.getText(),Integer.parseInt(tfDuree.getText()),Integer.parseInt(tfNbquestion.getText()));
        ...
        addAll(tfTheme,tfDuree,tfNbquestion,btnValider);
